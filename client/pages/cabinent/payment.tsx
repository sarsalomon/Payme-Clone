...
export default function CabinentPayment() {
    return(
        <>
            <Header></Header>
                ...
                <section className="ml-40 w-full pr-8">
                    ...
                    <div className="flex flex-col mt-6">
                        ...
                        <div className="mt-6">
                            <div>
                                <div className="flex items-center text-xl">
                                    <span>Saqlangan to'lovlar</span>
                                    <span className="px-4">1</span>
                                    <button className="border text-[#3cc] border-[#3cc] rounded-lg px-2">Yana</button>
                                </div>    
                            </div>
                            <div className="flex mt-2 ml-3">
                                <div className="flex flex-col text-center items-center px-4 py-10 border border-gray-300 rounded-xl hover:cursor-pointer hover:shadow-2xl transition duration-300">
                                    <img src="https://cdn.payme.uz/merchants/76fecb746b69a3ee09cba43bc3976751a9c0e6ce.png" alt="Mobiuz" width={140} />
                                </div>
                            </div>
                        </div>
